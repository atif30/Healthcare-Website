...
<div id="loader">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/our_logo2.png" alt="" style="height: 51px;"></a> </div>
      <div class="head-info">
        <ul>
          ...
          <li> <i class="fa fa-envelope-o"></i>
            <p>Elaajonclick@gmail.com<br>
            arsalan.ahmad910@gmail.com
              </p>
          </li>
          ...
          <ul class="nav">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Sign Up </a>
              <ul class="dropdown-menu multi-level" style="display: none;">
                ...
                <li><a href="DoctorSignup.php">Doctor</a></li>
