...
{
	$sql ="UPDATE doctor SET status='Active' WHERE doctorid='$_GET[doctorid]'";
	$qsql=mysqli_query($con,$sql);
	
	$sql ="UPDATE doctor SET status='Approved' WHERE doctorid='$_GET[approveid]'";
	$qsql=mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
...
<div class="block-header">
        <h2 class="text-center">Approve/Delete New Doctors</h2>
    </div>
