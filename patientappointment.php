    ...
    <div id="container">
        ...
        if(isset($_POST[submit]))
        {
         ...
         else
         {
             ...
             echo "<p class='text-center'> <a href='patientlogin.php'>Click here to go to Dashboard</a>. </p>";	
         }
     }
 }
 else
                        ...
                        <div class="col-lg-7">
                            <div class="appointment">
                                ...
                                <div class="heading-block head-left margin-bottom-50">
                                    <h6 style="color: #2b96cc; font-size: 25px;"><center><b>Make an Appointment</b></center></h6>
                            ...
                            ?>
                                ...
                                ?>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="Appointment Tentative Date" type="text" class="form-control"
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="Appointment Tentative Time" type="text"
